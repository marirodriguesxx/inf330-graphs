...
map<string,string> pathes; //armazenara a string contendo o caminho de transformacoes
map<string,int> values; //armazenara o numero de iteraçoes ate determinada organizacao
